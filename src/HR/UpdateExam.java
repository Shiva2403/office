...
//            Logger.getLogger(RemoveCourse.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            ...
            Shiva_Office so=new Shiva_Office();
            int r=so.updateExam(i,date,start,stop,m);
            if(r>0){
...
//            Logger.getLogger(UpdateExam.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        String date=null,start=null,stop=null,mark=null;
        try {
            ...
            Shiva_Office so=new Shiva_Office();
            ResultSet rs=so.searchExam(name,s);
            while(rs.next()){
                i=rs.getInt(1);
                date=rs.getString(4);
            ...
            jTextField2.setText(start);
            jTextField3.setText(stop);
